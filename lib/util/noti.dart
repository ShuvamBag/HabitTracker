...
class Noti{
  ...
  static Future showBigTextNotification({var id =0,required String title, required String body,
    ...
    await fln.zonedSchedule(0, title, body, tz.TZDateTime.from(scheduledate, tz.local),not, uiLocalNotificationDateInterpretation:UILocalNotificationDateInterpretation.absoluteTime,payload: payload,
